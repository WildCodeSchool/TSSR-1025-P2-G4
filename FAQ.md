...
Q : Comment récupérer le projet ? R : Clonez le dépôt GitHub avec la commande suivante :
...
Q : J'ai une erreur "Permission denied" en lançant le script, que faire ? R : Vous devez rendre le script exécutable avant de le lancer. Utilisez la commande :
