            ...
            do
                ...
                case $choice_grp in
                    1)
                        ...
                        if ssh -t -o ConnectTimeout=10 cliwin01 "Get-LocalGroup -Name 'Administrators' -ErrorAction SilentlyContinue" &>/dev/null
                        then
                            group_name="Administrators"

                        elif ssh -t -o ConnectTimeout=10 cliwin01 "Get-LocalGroup -Name 'Administrateurs' -ErrorAction SilentlyContinue" &>/dev/null
                        then
