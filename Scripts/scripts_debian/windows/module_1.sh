...
# Connexion Prise en main à distance
    ...
    echo
    sleep 1
    ~/Scripts/windows/menu_prise_en_main.sh "$NomMachine" "$IpMachine"
...
# Connexion Pare-feu
    ...
    echo
    sleep 1
    ~/Scripts/windows/menu_pare-feu.sh "$NomMachine" "$IpMachine"
...
# Connexion Redémarrer
    ...
    echo
    sleep 1
    ~/Scripts/windows/menu_redemarrage.sh  "$NomMachine" "$IpMachine"
