...
function Module_1() {
    ...
    source ~/Scripts/linux/module_1.sh "$NomMachine" "$IpMachine"
...
function Module_2() {
    ...
    # Sans oublié les arguments
    source ~/Scripts/linux/module_2.sh "$NomMachine" "$IpMachine"
...
function Module_3() { 
    ...
    # Sans oublié les arguments
    source ~/Scripts/linux/module3.sh "$NomMachine" "$IpMachine"
