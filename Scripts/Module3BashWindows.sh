...
function menu_sys(){
    ...
    read choix
        ...
        1) 
            Log "SysConsultBios"
            # Utilisation de WMIC ou PowerShell
        ...
        5) 
            ...
            # Calcul de l'uptime via PowerShell
...
function menu_logs(){
        ...
        1) 
            ...
            # Equivalent journalctl -p 0..3 : On cherche les erreurs dans System
