    ...
    case $choice_menu_gestion_rep in
        1)
            ...
            do
                ...
                elif ssh -t -o ConnectTimeout=10 clilin01 "[ -d '$rep_name' ]"
                then
                    clear
        ...
        2)
            ...
            do
                ...
                elif ! ssh -t -o ConnectTimeout=10 clilin01 "[ -d '$rep_rename' ]"
                then
                    clear
                    ...
                    if [[ "$new_rep_name" != /* || -z "$new_rep_name" ]]
                    then
                        clear
                        echo -e "\nAttention !\nVous n'avez rien saisi ou la saisie est incorrecte !\n\nVeuillez recommencer SVP."
                        Log "InputError"
        ...
        3)
            ...
            do
                ...
                #Vérification si le répertoire saisi existe
                elif ! ssh -t -o ConnectTimeout=10 clilin01 "[ -d '$rep_del' ]"
                then
                    clear
