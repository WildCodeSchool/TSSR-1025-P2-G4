...
* [Installation de nmap sur le serveur Debian](#installation-nmap-)
  ...
  - [Prérequis techniques](#prerequis-nmap)
...
* [Installation de nmap sur le serveur Windows](#installation-nmap-windows)
  ...
  - [Prérequis techniques](#prerequis-nmap-windows)
...
* [Installation de putty sur le serveur windows ](#installation-putty-)
  ...
  - [Prérequis techniques](#prereqis-putty)
...
Ce document détaille la procédure technique pour installer l'outil Nmap (Network Mapper) sur le serveur Debian de l'infrastructure. Nmap est une dépendance requise pour permettre au script d'administration d'effectuer des opérations de découverte réseau et d'audit de sécurité. Dans le cas présent il ne sert qu'à récupérer l'IP et le nom des machines du réseaux.
