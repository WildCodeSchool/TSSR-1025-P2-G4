...
function PriseEnMain {
    ...
    # Appel du script menu_prise_en_main.ps1
    & "$PSScriptRoot\windows\menu_prise_en_main.ps1" -NomMachine $NomMachine -IpMachine $IpMachine
}
...
function PareFeu {
    ...
    # Appel du script menu_pare-feu.ps1
    & "$PSScriptRoot\windows\menu_pare-feu.ps1" -NomMachine $NomMachine -IpMachine $IpMachine
}
...
function Redemarrage {
    ...
    # Appel du script menu_redemarrage.ps1
    & "$PSScriptRoot\windows\menu_redemarrage.ps1" -NomMachine $NomMachine -IpMachine $IpMachine
}
